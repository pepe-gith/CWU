  ...
  <div class="cabecera">
    ...
    <div class="users-form" id="users-form">
        <form action="/cwu/controladores/comprobarAcceso.php" method="POST">
            <h1>Acceso</h1>
            <label>NIF (o ID emplead@)</label><input type="text" name="NIF" id="NIF" title="CAMPO OBLIGATORIO - 8 números y la letra que corresponda en mayúscula" pattern="[0-9]{8}[A-Z]{1}" required>
