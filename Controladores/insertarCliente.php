...
<body>
   <h1 style="color:red"> <?php if ($filas > 0) printf ("ERROR NIF " . $NIF . " ya fue dado de alta"); ?> </h1>
   <h1 style="color:green"> <?php if ($filas == 0) printf ("El cliente con NIF " . $NIF . " ha sido dado de alta corréctamente"); ?> </h1>
